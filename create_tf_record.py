...
def create_records(image_dir,file, output_record_dir, resize_height, resize_width,shuffle,log=100):
    '''
...
if __name__ == '__main__':
    # 参数设置
    resize_height = 32  # 指定存储图片高度 256
    resize_width = 32  # 指定存储图片宽度 256
    shuffle=True
    log=3000
    # 产生train.record文件
    # image_dir= 'D:\\data\\classification\\train'
    # image_dir= 'D:\\data\\classification2\\train'
    # # train_labels = 'D:\\data\\classification\\train.txt' # 图片路径
    # train_labels = 'D:\\data\\classification2\\train.txt' # 图片路径
    # train_record_output = 'D:\\data\\classification2\\tfrecords\\train.tfrecords'
...
#     产生val.record文件
    shuffle=False
    image_dir='D:\\data\\classification2\\test'
    val_labels = 'D:\\data\\classification2\\test.txt'  # 图片路径
    val_record_output = 'D:\\data\\classification2\\tfrecords\\test_test.tfrecords'
